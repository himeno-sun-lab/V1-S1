...
target_layer_name = {'1': 'M1_L5B_PT','2': 'M1_L23_VIP'}
...
for n in range(len( circle_col_gids[layer_name])):
    ...
    plt.legend(loc='best')
    plt.title('Response of neurons populations to ' + target_layer_name['1']+ ' and '+ target_layer_name['2'] + ' stimulation inside col_' +str(target_micro_col_num) , fontsize = 30)
    save_results_to = '/home/morteza/Desktop/reports/191119 (quantify changes_micro_col)/L23_macro & L5B_micro/'
    plt.savefig( save_results_to + target_layer_name['1'] + ' and '+ target_layer_name['2'] + ' stim inside col no' + str(target_micro_col_num) + '.jpeg')
