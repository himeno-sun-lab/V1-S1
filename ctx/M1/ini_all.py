  ...
  for l in range(len(vS1_Layer_Name)):
    ...
    for n_type in ctx_params['vS1']['neuro_info'][vS1_Layer_Name[l]].keys():
      ...
      if n_type_info['EorI'] == "E":
        ...
        _=randomizing_mp(SubSubRegion_Excitatory[-1], n_type_info['spike_threshold'], n_type_info['reset_value'])
        ...
        _ = randomizing_mp(SubSubRegion_Inhibitory[-1], n_type_info['spike_threshold'], n_type_info['reset_value'])
      else:
